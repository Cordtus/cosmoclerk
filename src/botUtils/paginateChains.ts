...
export function paginateChains(chains: string[], currentPage: number, userId: number, pageSize: number = DEFAULT_PAGE_SIZE) {
  ...
  return Markup.inlineKeyboard([...buttons, ...navigationButtons], { columns: 3 });
}
