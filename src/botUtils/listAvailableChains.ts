...
export async function listAvailableChains(includeTestnets: boolean = false): Promise<string[]> {
  try {
    ...
    console.error(`[${new Date().toISOString()}] Error listing available chains:`, error);
    return [];
  }
}
