// chainUtils.js
const { readFileSafely } = require('./repoUtils'); // Adjust path as needed
const { isEndpointHealthy } = require('./coreUtils'); // Adjust path as needed
...
module.exports = { handleChainInfo };
